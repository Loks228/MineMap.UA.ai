...
def create_flag(color_name, main_color, dark_color, size=(48, 48)):
    try:
        ...
        print(f"❌ Error creating {color_name} flag: {e}")
        traceback.print_exc()
        return False

# Create flag designs for all colors
flags = [
    # color_name, main_color, dark_color
    ("red", (255, 0, 0), (125, 0, 0)),         # Red with darker red
    ("green", (0, 160, 0), (0, 82, 0)),        # Green with darker green
    ("yellow", (255, 204, 0), (128, 102, 0)),  # Yellow with gold
    ("purple", (139, 92, 246), (75, 0, 130)),  # Purple with indigo
    ("gray", (128, 128, 128), (64, 64, 64)),   # Gray with darker gray
    ("blue", (0, 102, 204), (0, 51, 110)),     # Blue with darker blue
]

# Generate all flags
success_count = 0
for color_name, main_color, dark_color in flags:
    if create_flag(color_name, main_color, dark_color):
        success_count += 1

print(f"\nSuccessfully created {success_count} of {len(flags)} flag designs") 